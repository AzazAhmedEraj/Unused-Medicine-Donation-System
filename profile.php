...
<head>
    ...
    <title>Unused Medicine Donation System - Profile</title>
    ...
    <i class="fas fa-heartbeat"></i> MedDonate
            ...
            <nav class="nav-links">
                <ul>
                    ...
                    <li><a href="index.html" class="btn-secondary"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                </ul>
            </nav>
            ...
            <section class="form-section">
                <div class="container">
                    ...
                    <div class="profile-display">
                        ...
                        <p><strong>User Type:</strong> [Individual/NGO]</p>
                    </div>
                    <h3>Edit Profile</h3>
                    ...
                    <div class="history-list cards-grid">
                        <div class="card">
                            <p>Donation #1: Paracetamol, 50 tablets, Donated on 10/15/2025</p>
                        </div>
                        <div class="card">
                            <p>Request #1: Aspirin, 20 tablets, Requested on 10/10/2025</p>
                        </div>
                    </div>
